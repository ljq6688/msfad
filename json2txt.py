...
if __name__ == '__main__':
    ...
    parser.add_argument('--json_file', default=r'H:\LJQ\datasets\coco\annotations\instances_val2017.json',
                        type=str, help="coco file path")
    parser.add_argument('--save_dir', default=r'H:\LJQ\datasets\coco\labels\val', type=str,
