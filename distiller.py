...
class FeatureLoss(nn.Module):
    ...
    def __init__(self,
        ...
        self.uni_channel = nn.Conv2d(teacher_channels,student_channels, 1, 1)
...
if __name__ == '__main__':
    a = FeatureLoss(128,256)
    d = FeatureLoss(234,456)
    c = []
    f = []
    for v in a.modules():
        for prename, pre in v.named_parameters(recurse=0):
            c.append(pre)
    for e in d.modules():
        f.append(dict(e.named_parameters()))
